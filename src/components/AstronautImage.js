...
/**
 * This component is built using `gatsby-background-image/src` to automatically
 ...
 * - `gatsby-background-image/src`: https://github.com/timhagn/gatsby-background-image/src
